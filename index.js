...
app.get('/index',(req,res)=>{
    ...
    app.get('/order',auth,(req,res)=>{
        res.send("Order Details requested for "+req.query.id); //reAD QUERY PARAMETER
        })

         // http://localhost:port/order/1/ordername // path parameter
    app.get('/order/:id/:name',auth,(req,res)=>{
        res.send("Order Details requested for "+req.params.id+" "+req.params.name); //read path parameter
        })
